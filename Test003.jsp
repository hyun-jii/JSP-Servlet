...
<!-- 
	※ 요청한 페이지의 결과를 확인한 후 새로고침을 반복해 보면...
	   a 변수(선언부에 선언된 변수) 값만 계속 증가하는 것을 확인할 수 있다.
	   ...
	   - 파일
	     ...
	     ==> 변수 a는 클래스(Test003_jsp)의 전역 변수로 선언된 것을 확인할 수 있다.
	         이는 객체가 소멸되기 전까지는 계속 값이 유지된다는 것을 의미한다.
	         변수 b는 메소드(Test003_jsp 클래스의  _jspService()) 내의 지역 변수로 선언된 것을 확인할 수 있다.
	         
	         『_jsInit()』 메소드와 『_jsDestory()』 메소드는
	         ...
	         다시 정의 되는 상황이 되어버리기 때문에 문법적으로 잘못된 표현이 된다.
